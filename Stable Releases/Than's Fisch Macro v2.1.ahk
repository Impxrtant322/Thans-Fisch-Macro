							...
							If (ErrorLevel = 1) {
								...
								If (CurrentTarget <= ((Control / 2) + fishBarLeftX + (Control / 4))) {
									...
									If (ErrorLevel = 0) {
										...
										if (CurrentBarCloseLeft < CurrentTarget && CurrentTarget < CurrentBarCloseRight) {
											...
											if (Percentage >= 0) {
												...
												tooltip % "Holding left click for: " Val " ms", WindowWidth / 2, ToolTipBarY + 25, 10
												If (Val = 0) {
													Reels(clickHoldTime)
												} else {
													Reels(Val)
										...
										PixelSearch, CurrentBarPosition,, fishBarLeftX, fishBarY, fishBarRightX, fishBarY, 0x4c4437, 20,FastRGB
										If (ErrorLevel = 0) {
											PixelSearch, CurrentTarget,, fishBarLeftX, fishBarY, fishBarRightX, fishBarY, 0x434b5b, 5, FastRGB
											CurrentBarPositionLeft := CurrentBarPosition
											CurrentBarPositionRight := CurrentBarPosition + Control
